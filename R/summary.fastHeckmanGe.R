#' summary.fastHeckmanGe
#'
#' Summary of Generalized Heckman Model
#'
#' @return
#' Print estimates of the parameters of the Optimized Generalized Heckman model
#' @param object fastHeckmanGe class object.
#' @param ... others functions.
#' @export summary.fastHeckmanGe
#' @export
summary.fastHeckmanGe  <- function(object, ... ){
