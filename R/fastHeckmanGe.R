...
#'
#' @details
#' The fastHeckmanGe() function fits a generalization of the Heckman sample
...
fastHeckmanGe <- function(selection, outcome, dispersion, correlation,
        ...
        if (is.null(start)){
                start_guess <- heckmange:::step2(YS     = YS,
                                                     XS     = XS,
                                                     YO     = YO,
                                                     XO     = XO,
                                                     Msigma = Msigma,
        ...
        result = heckmange:::fitfastHeckmanGe(start  =  start,
                                  YS     =  YS,
                                  XS     =  XS,
                                  YO     =  YO,
                                  XO     =  XO,
        ...
        if(!is.null(cluster)){
                ...
                vcov_clustered <- heckmange:::vcovCL.fastHeckmanGe(result, cluster = mf_cluster)
...
#start = NULL
#
#fastHeckmanGe <- function(selection, outcome, dispersion, correlation, data, weights, cluster, start = NULL) {
#
#        ##############################################################################
#        mf <- match.call(expand.dots = FALSE)
#        mf
#}
#
#mf = fastHeckmanGe(selectEq, outcomeEq, dispersion, correlation, cluster = subject.id, data = MEPS2001)
#object = fastHeckmanGe(selection = selectEq,
#              outcome   = outcomeEq,
